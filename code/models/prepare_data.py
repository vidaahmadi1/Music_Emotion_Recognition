...
# if __name__ == "__main__":
    ...
    # # tags = load_tags("/Users/Saeedeh/Desktop/audio_classification/data/tag.txt")
    # # labels = load_labels("/Users/Saeedeh/Desktop/audio_classification/data/labels.txt")
    # # df_59 = join_tags_labels(tags=tags, labels=labels)
    # # df_59.to_csv('/Users/Saeedeh/Desktop/audio_classification/data/label_59.csv', index = False)

    # # join_npz_files("/Users/Saeedeh/Desktop/audio_classification/data/vggish/*.npz")
